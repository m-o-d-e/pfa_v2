...
import 'addsoil_model.dart';
export 'addsoil_model.dart';
import '../../utlis/framwork_utils.dart';

class AddsoilWidget extends StatefulWidget {
  const AddsoilWidget({Key? key}) : super(key: key);

  @override
  _AddsoilWidgetState createState() => _AddsoilWidgetState();
}

class _AddsoilWidgetState extends State<AddsoilWidget> {
  late AddsoilModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddsoilModel());
